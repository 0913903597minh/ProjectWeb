...
! function(a, b) {
    ...
    ! function() {
        ...
        b.prototype.init = function() {
            ...
            if (this.s.controls && this.$items.length > 1 && (d = '<div class="lg-actions"><div class="lg-prev lg-icon"><i class="fa-solid fa-arrow-left">' + this.s.prevHtml + '</i></div><div class="lg-next lg-icon"><i class="fa-solid fa-arrow-right">' + this.s.nextHtml + "</i></div></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (f = '<div class="lg-sub-html"></div>'), b = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + c + '</div><div class="lg-toolbar group"><span class="lg-close lg-icon"><i class="fa-solid fa-xmark"></i></span></div>' + d + f + "</div></div>", a("body").append(b), this.$outer = a(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), g.setTop(), a(window).on("resize.lg orientationchange.lg", function() {
                    setTimeout(function() {
                        g.setTop()
                    }, 100)
            ...
            }, this.s.backdropDuration), this.s.download && this.$outer.find(".lg-toolbar").append('<a id="lg-download" target="_blank" download class="lg-download lg-icon"><i class="fa-solid fa-download"></i></a>'), this.prevScrollTop = a(window).scrollTop()
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            if (this.core.s.fullScreen) {
                ...
                a = '<span class="lg-fullscreen lg-icon"><i class="fa-solid fa-expand"></i></span>', this.core.$outer.find(".lg-toolbar").append(a), this.fullScreen()
            }
...
! function(a, b) {
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            var b = this,
                c = '<span id="lg-share" class="lg-icon"><i class="fa-solid fa-share"></i><ul class="lg-dropdown" style="position: absolute;">';
...
! function(a, b) {
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            var a = this;
            a.core.s.toogleThumb && (a.core.$outer.addClass("lg-can-toggle"), a.$thumbOuter.append('<span class="lg-toogle-thumb lg-icon"><i class="fa-solid fa-list"></i></span>'), a.core.$outer.find(".lg-toogle-thumb").on("click.lg", function() {
...
! function(a, b) {
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            var b = this,
                c = '<span class="lg-autoplay-button lg-icon"><i class="fa-solid fa-circle-play"></i></span>';
...
! function(a, b) {
    ...
    ! function() {
        ...
        d.prototype.init = function() {
            var b = this,
                c = '<span id="lg-zoom-in" class="lg-icon"><i class="fa-sharp fa-solid fa-magnifying-glass-plus"></i></span> <span id="lg-zoom-out" class="lg-icon"><i class="fa-sharp fa-solid fa-magnifying-glass-minus"></i></span>';
            b.core.s.actualSize && (c += '<span id="lg-actual-size" class="lg-icon"><i class="fa-regular fa-images"></i></span>'), b.core.s.useLeftForZoom ? b.core.$outer.addClass("lg-use-left-for-zoom") : b.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(c), b.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(c, d, e) {
